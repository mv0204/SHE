...
public class MyViewPagerAdapterRights extends FragmentStateAdapter {
    public MyViewPagerAdapterRights(@NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle) {
